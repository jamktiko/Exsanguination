...
Shader "DawnShaderHDRP/HairShaderHDRP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			Cull [_AlphaDstBlend]
			ZTest [_StencilWriteMaskGBuffer]
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( _Brighness * ( staticSwitch142 * tex2D( _NoiseTexture, ( packedInput.ase_texcoord5.xy * _NoiseTilling ) ).r ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_HairAlpha = packedInput.ase_texcoord2.xy * _HairAlpha_ST.xy + _HairAlpha_ST.zw;
				float4 tex2DNode2 = tex2Dbias( _HairAlpha, float4( uv_HairAlpha, 0, _MipBias) );
				float4 lerpResult82 = lerp( _RootColor , _TipColor , tex2DNode2.a);
				#ifdef _USEBASECOLOR_ON
				float4 staticSwitch142 = tex2DNode2;
				...
				surfaceDescription.BaseColor = ( _Brighness * ( staticSwitch142 * tex2D( _NoiseTexture, ( packedInput.ase_texcoord2.xy * _NoiseTilling ) ).r ) ).rgb;
				surfaceDescription.Normal = normalizeResult65.rgb;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( _SpecularTint * tex2DNode2.a );
...
/*ASEBEGIN
Version=19002
2560;1;2560;1058;2149.016;310.898;1.3;True;False
...
ASEEND*/
//CHKSM=16A995702F8FE518BDEA6C19BCAB01DCB91C4741