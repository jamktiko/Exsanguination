	...
	SubShader
	{
		...
		Pass
		{
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float2 uv_EmissiveMask1 = IN.ase_texcoord8.xy * _EmissiveMask1_ST.xy + _EmissiveMask1_ST.zw;
				float4 tex2DNode190 = tex2D( _EmissiveMask1, uv_EmissiveMask1 );
				float2 temp_cast_2 = (_EmissivePannerTilling1).xx;
				float2 texCoord192 = IN.ase_texcoord8.xy * temp_cast_2 + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_EmissiveMask1 = IN.ase_texcoord4.xy * _EmissiveMask1_ST.xy + _EmissiveMask1_ST.zw;
				float4 tex2DNode190 = tex2D( _EmissiveMask1, uv_EmissiveMask1 );
				float2 temp_cast_1 = (_EmissivePannerTilling1).xx;
				float2 texCoord192 = IN.ase_texcoord4.xy * temp_cast_1 + float2( 0,0 );
				float2 panner201 = ( ( _TimeParameters.x ) * _PannerProperty1 + texCoord192);
				float4 tex2DNode191 = tex2D( _EmissivePannerMap1, panner201 );
...
/*ASEBEGIN
Version=19001
2560;1;2560;1058;5117.728;3758.015;4.044079;True;False
...
ASEEND*/
//CHKSM=7690516E038CEE2647AD7D67817F18ECF39EEB68