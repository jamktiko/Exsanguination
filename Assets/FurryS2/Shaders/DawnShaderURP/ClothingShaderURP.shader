	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_BC = IN.ase_texcoord8.xy * _BC_ST.xy + _BC_ST.zw;
				...
				float2 uv_Texture01 = IN.ase_texcoord8.xy * _Texture01_ST.xy + _Texture01_ST.zw;
				...
				#endif
				float2 uv_Texture02 = IN.ase_texcoord8.xy * _Texture02_ST.xy + _Texture02_ST.zw;
				...
				#endif
				float2 uv_Texture03 = IN.ase_texcoord8.xy * _Texture03_ST.xy + _Texture03_ST.zw;
				...
				#endif
				float2 uv_Texture04 = IN.ase_texcoord8.xy * _Texture04_ST.xy + _Texture04_ST.zw;
				...
				float2 texCoord161 = IN.ase_texcoord8.xy * temp_cast_1 + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 lerpResult31 = lerp( float4( 0,0,0,0 ) , _BlendColor04 , tex2DNode2.a);
				float4 lerpResult132 = lerp( tex2DNode1 , ( lerpResult28 + lerpResult29 + lerpResult30 + lerpResult31 ) , ( ( _BlendColorPower01 * tex2DNode2.r ) + ( _BlendColorPower02 * tex2DNode2.g ) + ( _BlendColorPower03 * tex2DNode2.b ) + ( _BlendColorPower04 * tex2DNode2.a ) ));
				float2 uv_Texture01 = IN.ase_texcoord4.xy * _Texture01_ST.xy + _Texture01_ST.zw;
				float4 lerpResult55 = lerp( float4( 0,0,0,0 ) , tex2D( _Texture01, uv_Texture01 ) , tex2DNode2.r);
				#ifdef _BLENDTEXTURE01_ON
				float4 staticSwitch60 = lerpResult55;
				#else
				float4 staticSwitch60 = tex2DNode1;
				#endif
				float2 uv_Texture02 = IN.ase_texcoord4.xy * _Texture02_ST.xy + _Texture02_ST.zw;
				float4 lerpResult56 = lerp( float4( 0,0,0,0 ) , tex2D( _Texture02, uv_Texture02 ) , tex2DNode2.g);
				#ifdef _BLENDTEXTURE02_ON
				float4 staticSwitch61 = lerpResult56;
				#else
				float4 staticSwitch61 = tex2DNode1;
				#endif
				float2 uv_Texture03 = IN.ase_texcoord4.xy * _Texture03_ST.xy + _Texture03_ST.zw;
				float4 lerpResult57 = lerp( float4( 0,0,0,0 ) , tex2D( _Texture03, uv_Texture03 ) , tex2DNode2.b);
				#ifdef _BLENDTEXTURE03_ON
				float4 staticSwitch62 = lerpResult57;
				#else
				float4 staticSwitch62 = tex2DNode1;
				#endif
				float2 uv_Texture04 = IN.ase_texcoord4.xy * _Texture04_ST.xy + _Texture04_ST.zw;
				float4 lerpResult58 = lerp( float4( 0,0,0,0 ) , tex2D( _Texture04, uv_Texture04 ) , tex2DNode2.a);
				#ifdef _BLENDTEXTURE04_ON
				float4 staticSwitch63 = lerpResult58;
				#else
				...
				float4 tex2DNode159 = tex2D( _EmissiveMask, uv_EmissiveMask );
				float2 temp_cast_1 = (_EmissivePannerTilling).xx;
				float2 texCoord161 = IN.ase_texcoord4.xy * temp_cast_1 + float2( 0,0 );
				float2 panner170 = ( ( _TimeParameters.x ) * _PannerProperty + texCoord161);
				float4 tex2DNode160 = tex2D( _EmissivePannerMap, panner170 );
...
/*ASEBEGIN
Version=19001
2560;1;2560;1058;-289.746;1936.195;1;True;False
...
ASEEND*/
//CHKSM=2FE3A453B63A6B4D743D9606DFFE2342EBFE7CB3