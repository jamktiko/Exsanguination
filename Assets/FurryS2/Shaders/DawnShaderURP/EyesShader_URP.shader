	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord204 = IN.ase_texcoord8.xy * temp_cast_0 + temp_cast_1;
				...
				float2 uv_Coat = IN.ase_texcoord8.xy * _Coat_ST.xy + _Coat_ST.zw;
				...
				float3 BaseColor = BaseColor219.rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_Irissize).xx;
				float2 temp_cast_1 = (( ( 1.0 - _Irissize ) / 2.0 )).xx;
				float2 texCoord204 = IN.ase_texcoord4.xy * temp_cast_0 + temp_cast_1;
...
/*ASEBEGIN
Version=19001
2560;1;2560;1058;3024.746;2574.222;1.135998;True;False
...
ASEEND*/
//CHKSM=252E0FB84FBECE1345A7C9B23982E3FBCC643528